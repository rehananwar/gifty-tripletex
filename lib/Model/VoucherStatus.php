...
const TYPE_DEMO_TYPE = 'DEMO_TYPE';
const TYPE_DEBT_COLLECTION_3_4 = 'DEBT_COLLECTION_3_4';
const TYPE_DEBT_COLLECTION_4 = 'DEBT_COLLECTION_4';
...
const MESSAGE_SETTLED = 'SETTLED';
    ...
    public function getTypeAllowableValues()
    {
        return [
            self::TYPE_TRIPLETEX,
self::TYPE_DEMO_TYPE,
self::TYPE_DEBT_COLLECTION_3_4,
self::TYPE_DEBT_COLLECTION_4,        ];
    }
    /**
     * Gets allowable values of the enum
     *
