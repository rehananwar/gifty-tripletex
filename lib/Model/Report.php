...
'name' => 'string',
'description' => 'string',
'groups' => '\Swagger\Client\Model\ReportGroup[]'    ];
...
'groups' => 'getGroups'    ];
     ...
     * Sets groups
     *
     * @param \Swagger\Client\Model\ReportGroup[] $groups The report must have exactly two groups. The first specifies the columns, the second specifies the rows.
     *
     * @return $this
     */
