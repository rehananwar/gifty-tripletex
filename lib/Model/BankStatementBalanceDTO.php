...
/**
 * BankStatementBalanceDTO Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BankStatementBalanceDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BankStatementBalanceDTO';
...
'date' => 'getDate'    ];
     ...
     * Sets amount
     *
     * @param float $amount Balance on the given date.
     *
     * @return $this
     */
