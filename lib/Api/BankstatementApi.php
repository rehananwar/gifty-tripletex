...
class BankstatementApi
{
     ...
     * @return \Swagger\Client\Model\ResponseWrapperBankStatement
     */
    public function bankStatementImportImportBankStatement($file, $bank_id, $account_id, $from_date, $to_date, $file_format, $external_id = null)
    {
        list($response) = $this->bankStatementImportImportBankStatementWithHttpInfo($file, $bank_id, $account_id, $from_date, $to_date, $file_format, $external_id);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\ResponseWrapperBankStatement, HTTP status code, HTTP response headers (array of strings)
     */
    public function bankStatementImportImportBankStatementWithHttpInfo($file, $bank_id, $account_id, $from_date, $to_date, $file_format, $external_id = null)
    {
        $returnType = '\Swagger\Client\Model\ResponseWrapperBankStatement';
        $request = $this->bankStatementImportImportBankStatementRequest($file, $bank_id, $account_id, $from_date, $to_date, $file_format, $external_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bankStatementImportImportBankStatementAsync($file, $bank_id, $account_id, $from_date, $to_date, $file_format, $external_id = null)
    {
        return $this->bankStatementImportImportBankStatementAsyncWithHttpInfo($file, $bank_id, $account_id, $from_date, $to_date, $file_format, $external_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bankStatementImportImportBankStatementAsyncWithHttpInfo($file, $bank_id, $account_id, $from_date, $to_date, $file_format, $external_id = null)
    {
        $returnType = '\Swagger\Client\Model\ResponseWrapperBankStatement';
        $request = $this->bankStatementImportImportBankStatementRequest($file, $bank_id, $account_id, $from_date, $to_date, $file_format, $external_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function bankStatementImportImportBankStatementRequest($file, $bank_id, $account_id, $from_date, $to_date, $file_format, $external_id = null)
    {
