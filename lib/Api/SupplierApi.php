...
class SupplierApi
{
     ...
     *
     * @param  \Swagger\Client\Model\Supplier[] $body JSON representing a list of new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Swagger\Client\Model\Supplier[] $body JSON representing updates to object. Should have ID and version set. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ListResponseSupplier
